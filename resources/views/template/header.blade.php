  ...
  <div class="header-wrapper row m-0"> 
    <div class="header-logo-wrapper col-auto p-0">
      <div class="logo-wrapper">
        <a href="{{ url('/') }}">
          <img class="img-fluid" src="{{ URL::asset('bb.png') }}" alt="">
        </a>
      </div>
    ...
    <div class="nav-right col-10 col-sm-6 pull-right right-header p-0">
      <ul class="nav-menus">
        ...
        <li class="onhover-dropdown">
          <div class="notification-box">
            ...
            </svg><span class="badge rounded-pill badge-warning" id="total-notif"></span>
          </div>
          <div class="onhover-show-div notification-dropdown">
            <ul class="custom-scrollbar" id="ul-notifikasi">
      ...
      <li class="profile-nav onhover-dropdown pe-0 py-0 me-0">
        <div class="media profile-media" style="margin-top: 5px; float: right !important;">
          ...
          @php
          $rname = \App\Models\Role::where("code", Session("role_id"))->get()->first();
          @endphp
        </div>
        <label style="margin-right: 5px; margin-top: 5px; text-align: right;">
          <b style="font-size: 14px;">{{ Auth::user()->username }}</b>
        </label>
        <ul class="profile-dropdown onhover-show-div">
          ...
          <li>
            <a href="{{ url("bypass") }}">
              <i class="fa fa-cog"></i><span> Bypass </span>
            </a>
          </li>
          @endif
          <li>
